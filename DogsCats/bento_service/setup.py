...
setuptools.setup(
    name='DogVCatService',
    version='20210312134352_060EA7',
    description="BentoML generated model module",
    long_description="""# Generated BentoService bundle - DogVCatService:20210312134352_060EA7
...
""",
    ...
    package_data={
        'DogVCatService': ['bentoml.yml', 'artifacts/*']
    },
    entry_points={
        'console_scripts': [
            'DogVCatService=DogVCatService:cli',
        ],
    }
)
