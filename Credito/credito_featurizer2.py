...
label_column_dtype = { 'deu_default': "float64"} 
...
#     print(merge_two_dicts(feature_columns_dtype, label_column_dtype))
...
#         dtype=merge_two_dicts(feature_columns_dtype, label_column_dtype)) for file in input_files ]
    ...
    numeric_features = [ 'credito_coaplicante' ,'credito_fiador', 'financiamento_outro_lugar' , 'outros_creditos_aqui',  
                    'finance__credits__other_banks' , 'numero_dependentes' ,'duracao_residencia', 'valor_solicitado' ,               
                    'duracao_emprego' ,  'duracao_credito' ,'receita_disponivel' ]                
